...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"payment-container\">\n    <table>\n        <tbody>\n            <tr>\n                <td>Card Number</td>\n                <td> <input type=\"text\"></td>\n            </tr>\n            <tr>\n                <td>Card Holder</td>\n                <td> <input type=\"text\"></td>\n            </tr>\n            <tr>\n                <td>Expiry</td>\n                <td> <input type=\"text\"></td>\n            </tr>\n            <tr>\n                <td>CVV Number</td>\n                <td> <input type=\"password\"></td>\n            </tr>\n        </tbody>\n    </table>\n    <button (click)=\"onClickMakePayment()\">Make Payment</button>\n</div>");
...
let AuthenticationService = class AuthenticationService {
    ...
    login(email, password) {
        return this.http.post(_app_config__WEBPACK_IMPORTED_MODULE_4__["URL_CONFIG"].BASE_URL + _app_config__WEBPACK_IMPORTED_MODULE_4__["URL_CONFIG"].LOGIN_URL, { email: email, password: password })
    ...
    verifyOtp(otp) {
        return this.http.post(_app_config__WEBPACK_IMPORTED_MODULE_4__["URL_CONFIG"].BASE_URL + _app_config__WEBPACK_IMPORTED_MODULE_4__["URL_CONFIG"].VERIFY_OTP, { email: JSON.parse(localStorage.getItem('currentUser')), otp: otp })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(response => {
            return response;
        }));
    }
...
/* harmony import */ var _verify_top_verify_top_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./verify-top/verify-top.component */ "./src/app/verify-top/verify-top.component.ts");
/* harmony import */ var _booking_plan_booking_plan_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./booking-plan/booking-plan.component */ "./src/app/booking-plan/booking-plan.component.ts");
/* harmony import */ var _booking_payment_booking_payment_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./booking-payment/booking-payment.component */ "./src/app/booking-payment/booking-payment.component.ts");
/* harmony import */ var _booking_confirmation_booking_confirmation_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./booking-confirmation/booking-confirmation.component */ "./src/app/booking-confirmation/booking-confirmation.component.ts");
...
const appRoutes = [
    { path: "", component: _home_home_component__WEBPACK_IMPORTED_MODULE_4__["HomeComponent"], canActivate: [_guards__WEBPACK_IMPORTED_MODULE_5__["AuthGuard"]] },
    { path: "login", component: _login_login_component__WEBPACK_IMPORTED_MODULE_3__["LoginComponent"] },
    { path: "register", component: _register_register_component__WEBPACK_IMPORTED_MODULE_6__["RegisterComponent"] },
    { path: "verify-otp", component: _verify_top_verify_top_component__WEBPACK_IMPORTED_MODULE_7__["VerifyTopComponent"] },
    { path: "home", component: _home_home_component__WEBPACK_IMPORTED_MODULE_4__["HomeComponent"] },
    { path: "plan-booking", component: _booking_plan_booking_plan_component__WEBPACK_IMPORTED_MODULE_8__["BookingPlanComponent"] },
    { path: "booking-payment", component: _booking_payment_booking_payment_component__WEBPACK_IMPORTED_MODULE_9__["BookingPaymentComponent"] },
    { path: "booking-confirmation", component: _booking_confirmation_booking_confirmation_component__WEBPACK_IMPORTED_MODULE_10__["BookingConfirmationComponent"] },
...
/* harmony import */ var _verify_top_verify_top_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./verify-top/verify-top.component */ "./src/app/verify-top/verify-top.component.ts");
/* harmony import */ var _booking_plan_booking_plan_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./booking-plan/booking-plan.component */ "./src/app/booking-plan/booking-plan.component.ts");
...
/* harmony import */ var _booking_confirmation_booking_confirmation_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./booking-confirmation/booking-confirmation.component */ "./src/app/booking-confirmation/booking-confirmation.component.ts");
/* harmony import */ var _booking_payment_booking_payment_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./booking-payment/booking-payment.component */ "./src/app/booking-payment/booking-payment.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        declarations: [
            ...
            _verify_top_verify_top_component__WEBPACK_IMPORTED_MODULE_13__["VerifyTopComponent"],
            _booking_plan_booking_plan_component__WEBPACK_IMPORTED_MODULE_14__["BookingPlanComponent"],
            _booking_confirmation_booking_confirmation_component__WEBPACK_IMPORTED_MODULE_17__["BookingConfirmationComponent"],
            _booking_payment_booking_payment_component__WEBPACK_IMPORTED_MODULE_18__["BookingPaymentComponent"]
        ],
        providers: [
...
BookingConfirmationComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./booking-confirmation.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/booking-confirmation/booking-confirmation.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./booking-confirmation.component.scss */ "./src/app/booking-confirmation/booking-confirmation.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".payment-container {\n  border: 1px solid gray;\n  margin: 15% auto;\n  display: block;\n  padding: 5%;\n  border-radius: 5px;\n  width: 40%;\n  text-align: center;\n}\n.payment-container table {\n  width: 100%;\n  margin-bottom: 14%;\n}\n.payment-container table tr {\n  text-align: left;\n}\n.payment-container button {\n  outline: none;\n  border: none;\n  background: #4caf50;\n  border-radius: 2px;\n  text-align: center;\n  font-size: 12px;\n  padding: 4px 20px;\n  color: white;\n}\n.payment-container button:hover {\n  cursor: pointer;\n  box-shadow: 0 8px 16px 0 rgba(0, 0, 0, 0.2);\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let BookingPaymentComponent = class BookingPaymentComponent {
    constructor(route, router, userService) {
        this.route = route;
        this.router = router;
        this.userService = userService;
...
BookingPaymentComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_3__["UserService"] }
];
BookingPaymentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-booking-payment",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./booking-payment.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/booking-payment/booking-payment.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./booking-payment.component.scss */ "./src/app/booking-payment/booking-payment.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "BookingPlanComponent", function() { return BookingPlanComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
/* harmony import */ var _services__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../_services */ "./src/app/_services/index.ts");
...
let BookingPlanComponent = class BookingPlanComponent {
    constructor(route, router, userService) {
        this.route = route;
        this.router = router;
        this.userService = userService;
...
BookingPlanComponent.ctorParameters = () => [
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
    { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
    { type: _services__WEBPACK_IMPORTED_MODULE_3__["UserService"] }
];
BookingPlanComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-booking-plan",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./booking-plan.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/booking-plan/booking-plan.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./booking-plan.component.scss */ "./src/app/booking-plan/booking-plan.component.scss")).default]
    })
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".search-block {\n  text-align: center;\n  margin-top: 10%;\n}\n.search-block input {\n  padding: 10px 15px;\n  height: 58px;\n  font-size: 35px;\n  border: 2px solid gray;\n  border-radius: 4px;\n  width: 40%;\n}\n.search-btn-block {\n  text-align: center;\n  margin-top: 10px;\n}\n.search-btn-block button {\n  padding: 5px 20px;\n}\n.search-btn-block button:hover {\n  cursor: pointer;\n  background-color: #4caf50;\n  color: white;\n  border: none;\n}\n.grid-row {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n          flex-flow: row wrap;\n  -webkit-box-pack: start;\n          justify-content: flex-start;\n  margin: 5%;\n}\n.grid-item {\n  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);\n  -webkit-transition: 0.3s;\n  transition: 0.3s;\n  border-radius: 5px;\n  height: 245px;\n  flex-basis: 20%;\n  -ms-flex: auto;\n  width: 259px;\n  position: relative;\n  margin: 2%;\n  box-sizing: border-box;\n}\n.grid-item:hover {\n  cursor: pointer;\n  box-shadow: 0 8px 16px 0 rgba(0, 0, 0, 0.2);\n}\n.grid-item .img-blck img {\n  border-radius: 5px 5px 0 0;\n  vertical-align: middle;\n  border-style: none;\n  height: 150px;\n  width: 100%;\n}\n.grid-item .cntnt-blck {\n  padding: 10px;\n}\n.grid-item .cntnt-blck .place-name {\n  font-weight: 700;\n  display: -webkit-box;\n  -webkit-line-clamp: 1;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.grid-item .cntnt-blck .place-desc {\n  font-size: 11px;\n  display: -webkit-box;\n  -webkit-line-clamp: 2;\n  -webkit-box-orient: vertical;\n  overflow: hidden;\n  text-overflow: ellipsis;\n}\n.grid-item .cntnt-blck .place-province {\n  display: block;\n  font-weight: 500;\n  font-size: 11px;\n}\n.grid-item .cntnt-blck .place-book {\n  -webkit-box-pack: center;\n          justify-content: center;\n  display: -webkit-box;\n  display: flex;\n}\n.grid-item .cntnt-blck .place-book button {\n  outline: none;\n  border: none;\n  background: #4caf50;\n  border-radius: 2px;\n  text-align: center;\n  font-size: 12px;\n  padding: 4px 20px;\n  color: white;\n}\n.grid-item .cntnt-blck .place-book button:hover {\n  cursor: pointer;\n  box-shadow: 0 8px 16px 0 rgba(0, 0, 0, 0.2);\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".login-container {\n  background-image: url('login.jpg');\n  height: 100%;\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: cover;\n}\n.login-container .cred-container {\n  width: 25%;\n  margin-left: 3%;\n  padding: 2%;\n  border-radius: 10px;\n}\n.login-container .cred-container .blck {\n  margin-top: 230px;\n  border: 1px solid gray;\n  border-radius: 5px;\n}\n.login-container .cred-container .blck form {\n  padding: 5%;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".blcks {\n  display: -webkit-box;\n  display: flex;\n  height: 100%;\n}\n.blcks .reg-form {\n  width: 20%;\n  float: right;\n  margin-right: 5%;\n  margin-left: 5%;\n  margin-top: 10%;\n}\n.blcks .lft-blck {\n  -webkit-box-flex: 1;\n          flex: 1;\n  background-image: url('register_form.jpg');\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: cover;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VerifyTopComponent", function() { return VerifyTopComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
let VerifyTopComponent = class VerifyTopComponent {
    constructor(formBuilder, route, router, authenticationService, alertService) {
        this.formBuilder = formBuilder;
        this.route = route;
        this.router = router;
...
VerifyTopComponent.ctorParameters = () => [
...
VerifyTopComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-verify-top',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./verify-top.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/verify-top/verify-top.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./verify-top.component.scss */ "./src/app/verify-top/verify-top.component.scss")).default]
    })
], VerifyTopComponent);
...
module.exports = __webpack_require__(/*! /Users/upendra/Downloads/travel-app-web/src/main.ts */"./src/main.ts");
